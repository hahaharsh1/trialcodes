class ExcelSheet {
    ...
    drawSelection() {
      if (this.startCell && this.endCell) {
        ...
        this.updateMarchingAnts(startWidth - 0.5, startHeight - 0.5, widthSum - startWidth + 1, heightSum - startHeight + 1);
      }
    ...
    updateMarchingAnts(x, y, width, height) {
      this.marchingx = x;
      this.marchingy = y;
      this.marchingwidth = width;
      this.marchingheight = height;
      this.drawants();
    }
    ...
    handlePointerMove(event) {
      ...
      this.updateMarchingAnts(this.marchingx, this.marchingy, currpoint - this.marchingx + this.surplus, this.marchingheight);
    }
    ...
    if (this.heightresize && this.isIdMoving) {
      ...
      // Update marching ants
      this.updateMarchingAnts(this.marchingx, this.marchingy, this.marchingwidth, currpoint - this.marchingy + this.idsurplus);
    }
  ...
  handlePointerUp(event) {
    ...
    if (this.widthresize && this.isHeadMoving) {
      ...
      // Update marching ants
      this.updateMarchingAnts(this.marchingx, this.marchingy, this.endpoint - this.marchingx + this.surplus, this.marchingheight);
    }
    ...
    if (this.heightresize && this.isIdMoving) {
      ...
      // Update marching ants
      this.updateMarchingAnts(this.marchingx, this.marchingy, this.marchingwidth, this.rowEndPoint - this.marchingy + this.idsurplus);
    }
